 ...
 */ function createHooksInternal(config) {
   ...
   */ const getArrayQueryKey = (queryKey)=>{
   ...
   */ function useSSRQueryOptionsIfNeeded(pathAndInput, opts) {
    ...
    function useQuery(pathAndInput, opts) {
        ...
        const hook = reactQuery.useQuery(getArrayQueryKey(pathAndInput), (queryFunctionContext)=>{
            const actualOpts = {
                ...ssrOpts,
                trpc: {
                    ...ssrOpts?.trpc,
   ...
   */ function useSubscription(pathAndInput, opts) {
    ...
    function useInfiniteQuery(pathAndInput, opts) {
        ...
        // request option should take priority over global
        const shouldAbortOnUnmount = opts?.trpc?.abortOnUnmount ?? abortOnUnmount;
        const hook = reactQuery.useInfiniteQuery(getArrayQueryKey(pathAndInput), (queryFunctionContext)=>{
            const actualOpts = {
                ...ssrOpts,
                trpc: {
                    ...ssrOpts?.trpc,
