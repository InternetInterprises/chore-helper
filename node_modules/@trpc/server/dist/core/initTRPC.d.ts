 ...
 */
declare class TRPCBuilder<TParams extends Partial<RootConfigTypes> = {}> {
    context<TNewContext extends RootConfigTypes['ctx']>(): TRPCBuilder<import("../types").Simplify<Partial<Pick<{ [TKey in "ctx" | keyof TParams]: TKey extends "ctx" ? {
        ctx: TNewContext;
    }[TKey] : TKey extends keyof TParams ? TParams[TKey] : never; }, ({ [K_1 in keyof TParams]: TParams[K_1] extends undefined ? TParams : never; } extends infer T ? { [K in keyof T]: { [K_1 in keyof TParams]: TParams[K_1] extends undefined ? TParams : never; }[K] extends never ? never : K; } : never)[keyof TParams] | ((TNewContext extends undefined ? {
        ctx: TNewContext;
    } : never) extends never ? never : "ctx")>> & Omit<{ [TKey in "ctx" | keyof TParams]: TKey extends "ctx" ? {
        ctx: TNewContext;
    }[TKey] : TKey extends keyof TParams ? TParams[TKey] : never; }, ({ [K_1 in keyof TParams]: TParams[K_1] extends undefined ? TParams : never; } extends infer T ? { [K in keyof T]: { [K_1 in keyof TParams]: TParams[K_1] extends undefined ? TParams : never; }[K] extends never ? never : K; } : never)[keyof TParams] | ((TNewContext extends undefined ? {
        ctx: TNewContext;
    } : never) extends never ? never : "ctx")>>>;
    meta<TNewMeta extends RootConfigTypes['meta']>(): TRPCBuilder<import("../types").Simplify<Partial<Pick<{ [TKey in "meta" | keyof TParams]: TKey extends "meta" ? {
        meta: TNewMeta;
    }[TKey] : TKey extends keyof TParams ? TParams[TKey] : never; }, ({ [K_1 in keyof TParams]: TParams[K_1] extends undefined ? TParams : never; } extends infer T ? { [K in keyof T]: { [K_1 in keyof TParams]: TParams[K_1] extends undefined ? TParams : never; }[K] extends never ? never : K; } : never)[keyof TParams] | ((TNewMeta extends undefined ? {
        meta: TNewMeta;
    } : never) extends never ? never : "meta")>> & Omit<{ [TKey in "meta" | keyof TParams]: TKey extends "meta" ? {
        meta: TNewMeta;
    }[TKey] : TKey extends keyof TParams ? TParams[TKey] : never; }, ({ [K_1 in keyof TParams]: TParams[K_1] extends undefined ? TParams : never; } extends infer T ? { [K in keyof T]: { [K_1 in keyof TParams]: TParams[K_1] extends undefined ? TParams : never; }[K] extends never ? never : K; } : never)[keyof TParams] | ((TNewMeta extends undefined ? {
        meta: TNewMeta;
    } : never) extends never ? never : "meta")>>>;
